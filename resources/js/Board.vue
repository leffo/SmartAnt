<template>
    <div class="h-full flex flex-col items-stretch bg-purple-500">
        <div class="header text-white flex justify-between items-center mb-2 bg-purple-600">
            ...
            <div class="text-lg opacity-50 cursor-pointer hover:opacity-75">SmartAnt</div>
        ...
        <div class="h-full flex flex-1 flex-col items-stretch">
            ...
            <div class="flex flex-1 items-start overflow-x-auto mx-2">
                <div class="bg-gray-300 rounded-sm p2 mr-2 ml-2 list">
                    <div class="flex justify-between">
                        <div class="text-gray-800 pl-2 pb-2 font-bold">List title</div>
                    </div>

                    <div class="bg-white card rounded-sm p-2 cursor-pointer text_sm hover:bg-gray-100 mb-2 mr-2 ml-2">xxx</div>

                    <div class="bg-white card rounded-sm p-2 cursor-pointer text_sm hover:bg-gray-100 mb-2 mr-2 ml-2">xxx</div>

                    <div class="bg-white card rounded-sm p-2 cursor-pointer text_sm hover:bg-gray-100 mb-2 mr-2 ml-2">xxx</div>

                    <div class="rounded-sm p-2 text-gray-600 cursor-pointer hover:bg-gray-400 hover:text-gray-800 text-sm mb-2 mr-2 ml-2 ">Add new card</div>
                </div>
            </div>
        </div>
    </div>
